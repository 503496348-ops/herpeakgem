...
const INSTALL_HINT: Record<string, string> = {
  docling: "pip install herpeakgem[parse-docling]",
  markitdown: "pip install herpeakgem[parse-markitdown]",
};
    ...
    return (
      <SettingSection title={t("Docling")} description="">
        <SettingRow
          ...
          description="pip install herpeakgem[parse-docling]"
          control={null}
        />
      </SettingSection>
    );
    ...
    return (
      <SettingSection title={t("markitdown")} description="">
        <SettingRow
          ...
          description="pip install herpeakgem[parse-markitdown]"
          control={null}
        />
      </SettingSection>
    );
  ...
  return (
    ...
    >
      <SettingRow
        ...
        description={t(
          "Reserved — uses HerPeakGem's vision model to caption images during conversion.",
        )}
        control={
          <Toggle
            checked={llmImages}
