...
const SPLIT_RATIO_KEY = "herpeakgem.co_writer.split_ratio";
const SYNC_SCROLL_KEY = "herpeakgem.co_writer.sync_scroll";
const LOCAL_DRAFT_PREFIX = "herpeakgem.co_writer.draft.";
