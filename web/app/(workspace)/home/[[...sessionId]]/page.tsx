...
export default function ChatPage() {
  ...
  const handleSend = useCallback(
    async (content: string) => {
      ...
      // (how many times HerPeakGem may ask it) so the subagent capability uses it.
  ...
  // How many times HerPeakGem may consult the selected agent this turn. Seeded
...
function SubagentTabWatcher({
  ...
  useEffect(() => {
    // Group by turn so all of one turn's consults (HerPeakGem may ask the agent
