...
const GITHUB_REPO_URL = "https://github.com/503496348-ops/herpeakgem";
const DOCS_URL = "https://herpeakgem.info/";
const RECENTS_COLLAPSED_KEY = "herpeakgem.sidebar.recentsCollapsed";
