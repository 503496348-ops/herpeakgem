...
/** "HerPeakGem_Introduction.pdf" → "HerPeakGem Introduction" — the card title
  ...
  return (
    <>
      {/* Activity block pinned to the TOP: the status header
          ("HerPeakGem Exploring… · 8s" → "HerPeakGem responded. · 10s") with
          the exploring trace nested beneath it — expanded while HerPeakGem is
