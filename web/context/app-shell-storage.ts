...
export const ACTIVE_SESSION_STORAGE_KEY = "herpeakgem.activeSessionId.tab";
export const LANGUAGE_STORAGE_KEY = "herpeakgem-language";
export const SIDEBAR_COLLAPSED_STORAGE_KEY = "herpeakgem.sidebarCollapsed";
export const CHAT_RESPONSE_TIMEOUT_STORAGE_KEY =
  "herpeakgem.chatResponseTimeout";
...
export const ACTIVE_SESSION_EVENT = "herpeakgem:active-session";
export const LANGUAGE_EVENT = "herpeakgem:language";
export const SIDEBAR_COLLAPSED_EVENT = "herpeakgem:sidebar-collapsed";
