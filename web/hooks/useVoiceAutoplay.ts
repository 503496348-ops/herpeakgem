...
const SESSION_KEY_PREFIX = "herpeakgem.voiceAutoplay.session"; // "on" | "off"
const PROMPTED_KEY_PREFIX = "herpeakgem.voiceAutoplay.prompted"; // "1"
const GLOBAL_EVENT = "herpeakgem:voice-autoplay-global";
const SESSION_EVENT = "herpeakgem:voice-autoplay-session";
