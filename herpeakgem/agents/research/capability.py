...
:mod:`herpeakgem.agents._shared.tool_composition` policy — same as chat,
...
from herpeakgem.agents.research.pipeline import ResearchPipeline, SubTopicItem
from herpeakgem.agents.research.request_config import (
