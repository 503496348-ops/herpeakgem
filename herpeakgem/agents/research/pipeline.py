...
from herpeakgem.agents.research.data_structures import (
    DynamicTopicQueue,
    ToolTrace,
    TopicBlock,
    TopicStatus,
)
from herpeakgem.agents.research.utils.citation_manager import CitationManager
...
from herpeakgem.core.agentic.tool_dispatch import (
...
class ResearchPipeline:
    ...
    LLM call goes through :mod:`herpeakgem.core.agentic` primitives. The
...
class _RephraseLoopHost:
    ...
    async def resolve_pause(self, dispatch: DispatchOutcome) -> bool:
        from herpeakgem.agents.chat.agentic_pipeline import (
