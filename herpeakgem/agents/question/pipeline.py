...
to :mod:`herpeakgem.core.agentic` and the shared tool-composition policy.
"""
...
from herpeakgem.agents._shared.capability_result import emit_capability_result
...
from herpeakgem.core.agentic.labels import find_inline_labels
...
from herpeakgem.services.config import parse_language
from herpeakgem.services.llm import get_llm_config, prepare_multimodal_messages
from herpeakgem.services.path_service import get_path_service
from herpeakgem.services.prompt import get_prompt_manager
from herpeakgem.services.prompt.language import append_language_directive
from herpeakgem.services.sandbox import exec_capability_available
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="HerPeakGem Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="HerPeakGem Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
