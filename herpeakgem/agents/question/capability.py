...
from herpeakgem.core.agentic.usage import UsageTracker
from herpeakgem.core.capability_protocol import BaseCapability, CapabilityManifest
from herpeakgem.core.context import UnifiedContext
from herpeakgem.core.stream_bus import StreamBus
from herpeakgem.core.trace import merge_trace_metadata
from herpeakgem.i18n import StatusI18n
from herpeakgem.runtime.request_contracts import get_capability_request_schema
...
class DeepQuestionCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        if isinstance(followup_question_context, dict) and followup_question_context.get(
            ...
            from herpeakgem.agents.question.agents.followup_agent import FollowupAgent
        ...
        if mode != "mimic":
            ...
            from herpeakgem.agents.question.history import load_session_quiz_history
            from herpeakgem.agents.question.pipeline import QuestionPipeline
            from herpeakgem.agents.question.request_config import (
                build_question_runtime_config,
            )
            from herpeakgem.services.config import load_config_with_main
    ...
    async def _run_mimic_mode(
        ...
        * ``[Attached Documents]`` in  → no paper available; fall back to
        ...
        """
        from herpeakgem.agents.question.history import load_session_quiz_history
        from herpeakgem.agents.question.mimic_source import (
        ...
        from herpeakgem.services.config import load_config_with_main
        from herpeakgem.services.parsing.engines.mineru.config import MinerUError
