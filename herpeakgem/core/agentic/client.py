...
from herpeakgem.services.config import load_system_settings
from herpeakgem.services.llm import get_token_limit_kwargs, supports_tools
from herpeakgem.services.llm.reasoning_params import (
    build_openai_compatible_reasoning_kwargs,
)
from herpeakgem.services.provider_registry import find_by_name
...
def _build_native_provider_adapter(config: LLMClientConfig, spec: Any) -> Any | None:
    if spec.backend == "anthropic":
        from herpeakgem.services.llm.provider_core import AnthropicProvider
    ...
    if spec.backend == "openai_codex":
        from herpeakgem.services.llm.provider_core import OpenAICodexProvider
    ...
    if spec.backend == "github_copilot":
        from herpeakgem.services.llm.provider_core import GitHubCopilotProvider
