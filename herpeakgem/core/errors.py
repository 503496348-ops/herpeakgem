...
class HerPeakGemError(Exception):
    """Base class for all application errors in HerPeakGem."""
...
class ConfigurationError(HerPeakGemError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(HerPeakGemError):
    """Raised when input validation fails."""

    pass


class ServiceError(HerPeakGemError):
