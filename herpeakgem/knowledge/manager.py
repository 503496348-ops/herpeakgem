...
from herpeakgem.knowledge.kb_types import (
    LINKED_KB_TYPE,
    OBSIDIAN_KB_TYPE,
    SUBAGENT_KB_TYPE,
    external_root_of,
...
from herpeakgem.services.rag.index_probe import (
    inspect_kb_versions,
...
class KnowledgeBaseManager:
    ...
    def update_kb_status(
        ...
        if status == "ready":
            ...
            try:
                from herpeakgem.services.rag.embedding_signature import (
    ...
    def list_knowledge_bases(self) -> list[str]:
        ...
        if base_exists:
            for item in self.base_dir.iterdir():
                ...
                from herpeakgem.services.rag.index_versioning import list_kb_versions
