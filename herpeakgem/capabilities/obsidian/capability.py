...
vault (resolved by :mod:`herpeakgem.capabilities.obsidian.binding`). As a
...
from herpeakgem.capabilities.obsidian.binding import vault_for_turn
from herpeakgem.capabilities.obsidian.tools import OBSIDIAN_TOOL_NAMES
