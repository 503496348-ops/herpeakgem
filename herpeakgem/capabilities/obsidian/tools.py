...
:class:`~herpeakgem.capabilities.obsidian.capability.ObsidianCapability`, which
...
:mod:`herpeakgem.capabilities.obsidian.vault` operations.
...
from herpeakgem.capabilities.obsidian import vault as vault_ops
