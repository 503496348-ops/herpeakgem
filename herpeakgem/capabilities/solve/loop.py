...
:class:`herpeakgem.capabilities.solve.capability.DeepSolveCapability`.
"""
...
from herpeakgem.capabilities.protocol import PromptBlock
from herpeakgem.capabilities.solve.session import DEFAULT_MAX_REPLANS, get_session
