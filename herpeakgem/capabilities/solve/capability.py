...
(:class:`herpeakgem.capabilities.solve.loop.SolveLoopCapability`) mounts the
...
from herpeakgem.agents.chat.agentic_pipeline import AgenticChatPipeline
from herpeakgem.capabilities.solve.session import DEFAULT_MAX_REPLANS
from herpeakgem.capabilities.solve.tools import SOLVE_TOOL_NAMES
...
from herpeakgem.services.config.capabilities_settings import get_solve_params
