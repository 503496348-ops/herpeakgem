...
through :mod:`herpeakgem.services.subagent` and streaming its native run to the
...
from herpeakgem.capabilities.subagent.capability import SubagentCapability
from herpeakgem.capabilities.subagent.tools import (
    SUBAGENT_TOOL_NAMES,
    SUBAGENT_TOOL_TYPES,
    ConsultSubagentTool,
)
