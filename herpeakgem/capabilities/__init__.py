...
:mod:`herpeakgem.capabilities` (``solve``, ``mastery``). The chat loop imports
...
from herpeakgem.capabilities.protocol import KnowledgeCapability, LoopCapability, PromptBlock
from herpeakgem.capabilities.registry import (
    LOOP_CAPABILITIES,
