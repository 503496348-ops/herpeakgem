...
from herpeakgem.logging import configure_logging
...
def validate_tool_consistency():
    ...
    """
    try:
        from herpeakgem.runtime.registry.capability_registry import get_capability_registry
...
async def lifespan(app: FastAPI):
    ...
    try:
        from herpeakgem.services.llm import get_llm_client
    ...
    try:
        from herpeakgem.events.event_bus import get_event_bus
    ...
    try:
        from herpeakgem.services.partners import get_partner_manager
    ...
    try:
        from herpeakgem.services.cron import get_cron_service
    ...
    try:
        from herpeakgem.services.pocketbase_client import ping_pocketbase
    ...
    try:
        from herpeakgem.services.memory import (
...
app = FastAPI(
    ...
    # See: https://github.com/503496348-ops/herpeakgem/issues/112
...
try:
    from herpeakgem.services.setup import init_user_directories
...
from herpeakgem.api.routers import (
    agent_config,
    attachments,
    auth,
    book,
...
from herpeakgem.multi_user.router import router as multi_user_router  # noqa: E402
...
from herpeakgem.api.routers.auth import require_admin, require_auth  # noqa: E402
...
@app.get("/")
async def root():
    return {"message": "Welcome to HerPeakGem API"}


if __name__ == "__main__":
    from herpeakgem.api.run_server import main as run_server_main
