...
from herpeakgem.core.i18n import t
from herpeakgem.partners.config.paths import get_partner_media_dir
from herpeakgem.partners.helpers import safe_filename
from herpeakgem.services.partners import get_partner_manager, slugify_partner_id
...
from herpeakgem.services.partners.workspace import (
    list_assets,
    provision_assets,
    read_soul,
    remove_asset,
...
def _validate_channels_payload(channels: dict) -> None:
    ...
    from herpeakgem.partners.config.schema import ChannelsConfig
...
def _validate_llm_selection_payload(
    ...
    from herpeakgem.services.model_selection import apply_llm_selection_to_catalog
    from herpeakgem.services.partners.model_runtime import normalize_partner_llm_selection
...
def _resolve_soul_content(soul: SoulSpec | None) -> tuple[str, dict[str, str]]:
    ...
    from herpeakgem.services.partners.workspace import DEFAULT_SOUL
...
async def list_channel_schemas():
    ...
    from herpeakgem.api.routers._partners_channel_schema import all_channel_schemas
...
async def tool_options():
    ...
    """
    from herpeakgem.api.utils.tool_options import build_tool_options
...
async def start_partner(partner_id: str):
    ...
    # comes back in this state after a HerPeakGem restart (a manual /stop clears
...
async def partner_command_palette():
    from herpeakgem.services.partners.commands import partner_command_palette
...
async def _partner_chat_stream(
    ...
    from herpeakgem.core.stream import StreamEventType
