...
Why live here vs inside ``herpeakgem.partners.channels``?
...
from herpeakgem.services.partners.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    """
    from herpeakgem.partners.channels.registry import discover_all_with_errors
