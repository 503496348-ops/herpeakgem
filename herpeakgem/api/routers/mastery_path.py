...
from herpeakgem.learning import policy as learning_policy
from herpeakgem.learning import prompts as learning_prompts
from herpeakgem.learning.models import (
    KnowledgePoint,
    KnowledgeType,
    LearningModule,
    LearningStage,
...
async def _cancel_active_learning_turn(book_id: str) -> None:
    from herpeakgem.services.session import get_turn_runtime_manager
...
async def generate_from_notebook(book_id: str, body: GenerateFromNotebookRequest):
    ...
    from herpeakgem.services.llm import complete
