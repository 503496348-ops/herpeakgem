...
from herpeakgem.services.config import load_auth_settings
...
from herpeakgem.multi_user.context import set_current_user, user_from_token_payload
from herpeakgem.multi_user.paths import local_admin_user
from herpeakgem.services.auth import (
    AUTH_ENABLED,
    POCKETBASE_ENABLED,
    TOKEN_EXPIRE_HOURS,
    TokenPayload,
...
def _local_admin_token_payload() -> TokenPayload:
    ...
    ``herpeakgem/multi_user/paths.py``.
    """
