...
from herpeakgem.core.capability_protocol import BaseCapability
from herpeakgem.i18n.metadata_i18n import capability_description_i18n
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("herpeakgem.plugins.loader")
    except Exception:
