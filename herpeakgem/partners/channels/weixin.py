...
from herpeakgem.partners.config.paths import get_media_dir, get_runtime_subdir
from herpeakgem.partners.config.schema import DeliveryOverrides
from herpeakgem.partners.helpers import safe_filename, split_message
...
class WeixinChannel(BaseChannel):
    ...
    async def _send_text(
        ...
        client_id = f"herpeakgem-{uuid.uuid4().hex[:12]}"
