...
from herpeakgem.services.voice.adapters import get_stt_adapter, get_tts_adapter
from herpeakgem.services.voice.base import VoiceProviderError, strip_markdown_for_speech
from herpeakgem.services.voice.config import STTConfig, TTSConfig
