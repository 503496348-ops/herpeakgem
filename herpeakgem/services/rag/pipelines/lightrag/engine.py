...
fix. All imports are lazy so HerPeakGem runs fine without the optional dependency
installed.

A RAG-Anything instance is built from HerPeakGem's LLM/vision/embedding adapters
