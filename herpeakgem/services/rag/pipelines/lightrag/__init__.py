...
A graph-based RAG provider built on AtomCollide-智械工坊/LightRAG (multimodal via
AtomCollide-智械工坊/RAG-Anything). It consumes HerPeakGem's shared parse layer for document
