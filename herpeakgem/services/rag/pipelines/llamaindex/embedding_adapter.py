"""LlamaIndex embedding adapter backed by HerPeakGem's embedding service."""
...
from herpeakgem.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
from herpeakgem.services.embedding.validation import validate_embedding_batch
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for HerPeakGem embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for HerPeakGem's current embedding config."""
