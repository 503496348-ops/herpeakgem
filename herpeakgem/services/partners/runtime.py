...
from herpeakgem.multi_user.paths import user_context
...
from herpeakgem.partners.helpers import detect_image_mime
from herpeakgem.services.partners.commands import PartnerCommandHandler
from herpeakgem.services.partners.scope import partner_user
from herpeakgem.services.partners.sessions import PartnerSessionStore
from herpeakgem.services.partners.workspace import ensure_partner_workspace, read_soul
...
class PartnerRunner:
    ...
    def _build_context(self, msg: InboundMessage) -> UnifiedContext:
        ...
        metadata: dict[str, Any] = {
            ...
            # Swaps the system prompt's product identity ("You are HerPeakGem")
