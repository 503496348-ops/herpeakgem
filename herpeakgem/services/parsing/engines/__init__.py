...
Each engine implements the :class:`~herpeakgem.services.parsing.base.Parser`
contract and is selected by name through :mod:`herpeakgem.services.parsing.engines.factory`.
