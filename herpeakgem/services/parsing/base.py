...
stage. An engine turns bytes/path into a :class:`~herpeakgem.services.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`herpeakgem.services.parsing.cache.load_ir` and writes
