...
Unified service layer for HerPeakGem providing:
...
Usage:
    ...
    from herpeakgem.services.embedding import get_embedding_client
    from herpeakgem.services.rag import RAGService
