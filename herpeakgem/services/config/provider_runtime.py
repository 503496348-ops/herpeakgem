"""Nanobot-style normalized runtime configuration for HerPeakGem."""
...
from herpeakgem.services.model_selection import LLMSelection, apply_llm_selection_to_catalog
from herpeakgem.services.provider_registry import (
...
from herpeakgem.services.voice.config import (
    AUTH_API_KEY_HEADER,
    AUTH_BEARER,
    STT_BASE64_JSON,
    STT_MULTIPART,
