...
HerPeakGem's chat runs as per-turn tasks inside one event loop, while MCP
...
from herpeakgem.core.tool_protocol import BaseTool, ToolDefinition, ToolResult
from herpeakgem.services.mcp.config import (
    MCPConfig,
    MCPServerConfig,
    load_mcp_config,
)
from herpeakgem.services.mcp.pageindex_server import with_builtin_servers
