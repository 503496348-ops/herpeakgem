...
Usage:
    from herpeakgem.services.pocketbase_client import get_pb_client, is_pocketbase_enabled
...
from herpeakgem.services.config import load_integrations_settings
