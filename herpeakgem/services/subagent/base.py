...
from herpeakgem.services.subagent.types import ConsultResult, DetectResult, SubagentEvent
...
class SubagentBackend(ABC):
    ...
    async def consult(
        ...
        *,
        ...
        subagent keeps context across HerPeakGem's successive questions); the
