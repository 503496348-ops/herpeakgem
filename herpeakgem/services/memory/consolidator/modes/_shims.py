"""Legacy public-API shims for :mod:`herpeakgem.services.memory.store`.
...
from herpeakgem.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from herpeakgem.services.memory.document import parse, serialize
from herpeakgem.services.memory.ops import ApplyReport, Op
