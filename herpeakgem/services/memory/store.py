...
from herpeakgem.services.memory import consolidator, paths, trace
from herpeakgem.services.memory.consolidator import ConsolidateResult, OnEvent
from herpeakgem.services.memory.document import Document, parse, serialize
from herpeakgem.services.memory.ops import AddOp, ApplyReport, EditOp
from herpeakgem.services.memory.ops import apply as ops_apply
...
_NO_MEMORY = (
    "(No memory available — interact with HerPeakGem and update from the Memory page to build one.)"
)
...
class MemoryStore:
    ...
    async def apply_ops_payload(
        ...
        """
        from herpeakgem.services.memory.consolidator import _parse_ops_response
