...
from herpeakgem.api.routers.mastery_path import router
...
def app(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "herpeakgem.api.routers.mastery_path.LearningStore",
...
class TestGenerateFromNotebook:
    ...
    @patch("herpeakgem.services.llm.complete", new_callable=AsyncMock)
    ...
    @patch("herpeakgem.api.routers.mastery_path.get_ui_language", return_value="en")
    @patch("herpeakgem.services.llm.complete", new_callable=AsyncMock)
    ...
    @patch("herpeakgem.api.routers.mastery_path.get_ui_language", return_value="zh")
    @patch("herpeakgem.services.llm.complete", new_callable=AsyncMock)
