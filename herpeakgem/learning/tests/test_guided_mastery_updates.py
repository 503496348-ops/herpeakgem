...
from herpeakgem.learning.mastery import compute_mastery
...
from herpeakgem.learning.scheduler import SpacedRepetitionScheduler
...
def test_grade_and_record_blank_wrong_is_metacognitive(tmp_path):
    ...
    from herpeakgem.learning.models import ErrorType
...
def test_pending_question_set_and_clear_round_trip(tmp_path):
    from herpeakgem.learning.models import PendingQuestion
