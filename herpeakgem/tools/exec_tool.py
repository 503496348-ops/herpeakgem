...
runs through the :mod:`herpeakgem.services.sandbox` layer rather than a raw
...
# NOTE: ``herpeakgem.services.sandbox`` is imported lazily inside ``execute``
# (not at module top). This tool is loaded by ``herpeakgem.tools.builtin``,
