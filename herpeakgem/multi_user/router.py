...
from herpeakgem.api.routers.auth import require_admin
...
from herpeakgem.services.skill.service import SkillService
...
async def admin_install_skill(
    ...
    lives in :func:`herpeakgem.services.skill.hub.install_from_hub`; this
