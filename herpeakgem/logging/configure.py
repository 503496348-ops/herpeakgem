...
_CONFIGURED = False
_MANAGED_ATTR = "_herpeakgem_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    logging.getLogger("herpeakgem").setLevel(logging.DEBUG)
    logging.getLogger("herpeakgem").propagate = True
