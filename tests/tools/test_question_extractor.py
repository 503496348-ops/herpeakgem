...
def _load_question_extractor_module():
    ...
    stubbed_modules = {
        "herpeakgem.services.config": {"get_agent_params": lambda *_args, **_kwargs: {}},
        "herpeakgem.services.llm": {"complete": lambda *_args, **_kwargs: None},
        "herpeakgem.services.llm.capabilities": {
            "supports_response_format": lambda *_args, **_kwargs: False
        },
        "herpeakgem.services.llm.config": {"get_llm_config": lambda: None},
        "herpeakgem.utils.json_parser": {"parse_json_response": lambda *_args, **_kwargs: {}},
    }
