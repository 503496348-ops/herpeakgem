...
memory_router = importlib.import_module("herpeakgem.api.routers.memory").router
paths_mod = importlib.import_module("herpeakgem.services.memory.paths")
document_mod = importlib.import_module("herpeakgem.services.memory.document")
