...
def test_install_current_user_maps_none_to_local_admin() -> None:
    ...
    from herpeakgem.api.routers.auth import _install_current_user
    from herpeakgem.multi_user.context import get_current_user_or_none, reset_current_user
    from herpeakgem.multi_user.models import LOCAL_ADMIN_ID, LOCAL_ADMIN_USERNAME
...
def test_install_current_user_maps_payload_to_scoped_user() -> None:
    ...
    from herpeakgem.api.routers.auth import _install_current_user
    from herpeakgem.multi_user.context import get_current_user_or_none, reset_current_user
    from herpeakgem.services.auth import TokenPayload
...
def test_local_admin_token_payload_matches_local_admin_user() -> None:
    ...
    from herpeakgem.api.routers.auth import _local_admin_token_payload
    from herpeakgem.multi_user.models import LOCAL_ADMIN_ID, LOCAL_ADMIN_USERNAME
    from herpeakgem.multi_user.paths import local_admin_user
...
def test_require_auth_propagates_user_contextvar_to_endpoint(monkeypatch) -> None:
    ...
    from herpeakgem.api.routers import auth as auth_router
    from herpeakgem.multi_user.context import get_current_user_or_none
    from herpeakgem.services.auth import TokenPayload
...
def test_path_service_resolves_per_user_workspace_through_dependency(monkeypatch, tmp_path) -> None:
    ...
    admin fallback."""
    from herpeakgem.api.routers import auth as auth_router
    from herpeakgem.multi_user import paths as mu_paths
    from herpeakgem.services.auth import TokenPayload
