...
from herpeakgem.api.routers import settings as settings_router
...
from herpeakgem.services.embedding import client as embedding_client_module
from herpeakgem.services.embedding import config as embedding_config_module
from herpeakgem.services.llm import client as llm_client_module
from herpeakgem.services.llm import config as llm_config_module
...
async def test_network_settings_roundtrip_normalizes_cors_origins(
    ...
    payload = settings_router.NetworkSettingsUpdate(
        backend_port=8101,
        frontend_port=3882,
        public_api_base="https://api.example.com/herpeakgem",
    ...
    assert response["settings"]["public_api_base"] == "https://api.example.com/herpeakgem"
...
async def test_mineru_payload_includes_local_cli_probe(
    ...
    from herpeakgem.services.parsing.engines.mineru import backend as mineru_backend
...
async def test_mineru_models_download_start_requires_downloader(
    ...
    from herpeakgem.services.parsing.engines.mineru import models as mineru_models
...
async def test_fetch_models_returns_picker_options(monkeypatch: pytest.MonkeyPatch) -> None:
    import herpeakgem.services.llm.factory as factory_module
