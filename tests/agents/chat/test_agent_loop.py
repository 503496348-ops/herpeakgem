...
from herpeakgem.agents.chat.agent_loop import InlineThinkFilter
from herpeakgem.agents.chat.agentic_pipeline import AgenticChatPipeline
from herpeakgem.capabilities.explore_context import explorer as explorer_mod
from herpeakgem.capabilities.mastery import MASTERY_TOOL_NAMES
...
from herpeakgem.core.tool_protocol import ToolResult
...
def test_compose_enabled_tools_injects_rag_when_kb_selected(
    ...
    monkeypatch.setattr(
        "herpeakgem.services.notebook.get_notebook_manager",
