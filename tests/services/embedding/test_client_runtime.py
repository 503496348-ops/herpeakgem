...
from herpeakgem.services.embedding.client import (
    EmbeddingClient,
...
async def test_embedding_client_batches_requests(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "herpeakgem.services.embedding.client._resolve_adapter_class", lambda _b: _FakeAdapter
    )
...
async def test_embedding_client_rejects_null_vector_values(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "herpeakgem.services.embedding.client._resolve_adapter_class",
...
def test_get_embedding_client_refreshes_when_config_changes(monkeypatch) -> None:
    from herpeakgem.services.embedding import client as client_module
