...
async def run_test(
    *,
    ...
    from herpeakgem.services.llm.config import LLMConfig, get_llm_config
    ...
    try:
        from herpeakgem.services.llm.factory import complete
    ...
    if test_stream:
        ...
        try:
            from herpeakgem.services.llm.factory import stream
