...
from herpeakgem.services.memory.document import Document, Entry, parse
from herpeakgem.services.memory.ops import AddOp, ApplyReport, DeleteOp, EditOp, apply
