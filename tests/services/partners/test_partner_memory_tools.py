...
from herpeakgem.multi_user.paths import get_admin_path_service, user_context
from herpeakgem.partners.config.paths import get_partner_sessions_dir, get_partner_workspace
...
def _fresh_memory_singleton(monkeypatch):
    ...
    from herpeakgem.services.memory import store
