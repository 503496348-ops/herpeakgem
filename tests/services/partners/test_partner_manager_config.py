...
from herpeakgem.services.partners.manager import PartnerConfig, PartnerManager
from herpeakgem.services.partners.workspace import DEFAULT_SOUL, read_soul
