...
from herpeakgem.services.generation_http import (
    GenerationProviderError,
    build_auth_headers,
    join_api_path,
)
from herpeakgem.services.imagegen import generate_image
from herpeakgem.services.imagegen.adapters.chat_completions import ChatCompletionsImagegenAdapter
from herpeakgem.services.imagegen.adapters.openai_compat import OpenAICompatImagegenAdapter
from herpeakgem.services.imagegen.config import ImagegenConfig
from herpeakgem.services.videogen import generate_video, probe_video
from herpeakgem.services.videogen.adapters.async_task import AsyncTaskVideogenAdapter
from herpeakgem.services.videogen.config import VideogenConfig
...
async def test_imagegen_tool_saves_public_artifact(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import herpeakgem.services.imagegen as imagegen_mod
    from herpeakgem.services.path_service import get_path_service
    from herpeakgem.tools.media_gen_tool import ImagegenTool
...
async def test_videogen_tool_forwards_progress_and_saves(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from herpeakgem.services.path_service import get_path_service
    import herpeakgem.services.videogen as videogen_mod
    from herpeakgem.tools.media_gen_tool import VideogenTool
