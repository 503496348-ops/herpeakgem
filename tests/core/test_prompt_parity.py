...
AGENTS_DIR = PROJECT_ROOT / "herpeakgem" / "agents"
# Modules that live outside herpeakgem/agents/ but still own prompts.
EXTRA_PROMPT_MODULE_DIRS = (
    PROJECT_ROOT / "herpeakgem" / "book",
    PROJECT_ROOT / "herpeakgem" / "co_writer",
)
