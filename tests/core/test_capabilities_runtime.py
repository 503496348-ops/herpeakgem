...
from herpeakgem.agents.chat.capability import ChatCapability
from herpeakgem.agents.question.capability import DeepQuestionCapability
from herpeakgem.agents.research.capability import DeepResearchCapability
from herpeakgem.agents.visualize.capability import VisualizeCapability
import herpeakgem.agents.visualize.pipeline as visualize_pipeline
from herpeakgem.capabilities.solve.capability import DeepSolveCapability
...
from herpeakgem.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
async def test_chat_capability_streams_content_and_geogebra_context(
    ...
    monkeypatch.setattr("herpeakgem.agents.chat.capability.AgenticChatPipeline", FakePipeline)
...
async def test_deep_solve_capability_runs_chat_loop_in_solve_mode(
    ...
    monkeypatch.setattr("herpeakgem.capabilities.solve.capability.AgenticChatPipeline", FakePipeline)
...
async def test_deep_question_capability_uses_single_call_followup_agent(
    ...
    _install_module(
        monkeypatch,
        "herpeakgem.agents.question.coordinator",
        AgentCoordinator=FakeCoordinator,
    )
    _install_module(
        monkeypatch,
        "herpeakgem.agents.question.agents.followup_agent",
        FollowupAgent=FakeFollowupAgent,
    )
    _install_module(
        monkeypatch,
        "herpeakgem.services.llm.config",
...
async def test_deep_research_capability_delegates_to_pipeline(
    ...
    """
    import herpeakgem.agents.research.capability as deep_research_mod
    import herpeakgem.agents.research.request_config  # noqa: F401
