"""CLI smoke tests for the standalone ``herpeakgem-cli`` package."""
...
def _install_fake_runtime(monkeypatch, captured_requests: list[TurnRequest]) -> None:
    ...
    monkeypatch.setattr("herpeakgem.app.facade.HerPeakGemApp.start_turn", _start_turn)
    monkeypatch.setattr("herpeakgem.app.facade.HerPeakGemApp.stream_turn", _stream_turn)
...
def test_session_list_command_uses_shared_store(monkeypatch) -> None:
    ...
    monkeypatch.setattr("herpeakgem.app.facade.HerPeakGemApp.list_sessions", _list_sessions)
...
def test_start_command_delegates_to_runtime_launcher(monkeypatch) -> None:
    ...
    monkeypatch.setattr("herpeakgem.runtime.launcher.start", _fake_start)
