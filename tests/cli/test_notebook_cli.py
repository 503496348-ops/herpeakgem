"""CLI smoke tests for ``herpeakgem notebook`` commands."""
...
def _patch_facade(monkeypatch) -> None:
    """Patch HerPeakGemApp methods to use the shared fake manager."""
    ...
    from herpeakgem.app import facade

    monkeypatch.setattr(facade.HerPeakGemApp, "create_notebook", _create_notebook)
    monkeypatch.setattr(facade.HerPeakGemApp, "get_notebook", _get_notebook)
    monkeypatch.setattr(facade.HerPeakGemApp, "add_record", _add_record)
    monkeypatch.setattr(facade.HerPeakGemApp, "update_record", _update_record)
    monkeypatch.setattr(facade.HerPeakGemApp, "remove_record", _remove_record)
