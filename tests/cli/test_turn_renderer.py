...
The chat agent loop (herpeakgem/agents/chat/agent_loop.py) streams every
...
from herpeakgem.app import TurnRequest
from herpeakgem_cli import common as cli_common
from herpeakgem_cli.common import _resolve_answer
...
def _install_fake_runtime(
    ...
    *,
    ...
    monkeypatch.setattr("herpeakgem.app.facade.HerPeakGemApp.submit_user_reply", _submit_user_reply)
