# HerPeakGem v1.4.5 Release Notes
...
A new loop-plugin framework (`herpeakgem/loop_plugins/`) lets a feature
...
- Drop-in from v1.4.4: `pip install -U herpeakgem`; Docker users pull
  `ghcr.io/atomcollide/herpeakgem:latest`. No migrations — existing learning
  progress loads as-is.
- Windows launch scripts moved into `scripts/`: run
  `scripts\start_backend.bat` / `scripts\start_frontend.bat`.

**Full Changelog**: https://github.com/503496348-ops/herpeakgem/compare/v1.4.4...v1.4.5
