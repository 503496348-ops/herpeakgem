# HerPeakGem v1.3.9 Release Notes
...
- **Minimal thinking mode is provider-safe** - DeepSeek, DashScope, VolcEngine,
  ...
  `reasoning_effort=minimal`; HerPeakGem sends the provider-specific disable
  signal instead.
...
- **`herpeakgem start` launches the full web stack** - the CLI now delegates to
...
- Added CLI coverage so `herpeakgem start` propagates the launcher exit code.
...
**Full Changelog**: https://github.com/503496348-ops/herpeakgem/compare/v1.3.8...v1.3.9
