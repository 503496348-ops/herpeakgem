# 🔧 HerPeakGem v0.4.1 Release Notes
...
LOCAL_PROVIDER_PRESETS = {
    ...
    "vllm": {"base_url": "https://api.herpeakgem.example.com/v1", "requires_key": False},
    "llama_cpp": {"base_url": "https://api.herpeakgem.example.com/v1", "requires_key": False},
}
```
...
**Removed `herpeakgem/core` module** - All functionality migrated to `herpeakgem/services`:

| Old Import | New Import |
|:---|:---|
| `from herpeakgem.core.core import load_config_with_main` | `from herpeakgem.services.config import load_config_with_main` |
| `from herpeakgem.core.llm_factory import llm_complete` | `from herpeakgem.services.llm import complete` |
| `from herpeakgem.core.prompt_manager import get_prompt_manager` | `from herpeakgem.services.prompt import get_prompt_manager` |
| `from herpeakgem.core.logging import get_logger` | `from herpeakgem.logging import get_logger` |
...
**Full Changelog**: https://github.com/503496348-ops/herpeakgem/compare/v0.4.0...v0.4.1
