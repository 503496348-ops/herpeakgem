# HerPeakGem v1.3.7 Release Notes
...
- Set `LLM_REASONING_EFFORT` in `.env` if you need global thinking control.
  Leave it empty to let HerPeakGem auto-detect behavior from the active model.
...
**Full Changelog**: https://github.com/503496348-ops/herpeakgem/compare/v1.3.6...v1.3.7
