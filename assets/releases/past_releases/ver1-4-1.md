# HerPeakGem v1.4.1 Release Notes
...
multimodal image-fallback fix for providers HerPeakGem has no vision entry for.
...
## Upgrade Notes
- Drop-in from v1.4.0: `pip install -U herpeakgem`; Docker users pull
...
**Full Changelog**: https://github.com/503496348-ops/herpeakgem/compare/v1.4.0...v1.4.1
