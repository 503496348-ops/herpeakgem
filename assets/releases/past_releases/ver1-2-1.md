# HerPeakGem v1.2.1 Release Notes
...
- **CLI** — `/regenerate` (alias `/retry`) inside the `herpeakgem chat` REPL.
...
**Full Changelog**: https://github.com/503496348-ops/herpeakgem/compare/v1.2.0...v1.2.1
