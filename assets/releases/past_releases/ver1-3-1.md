# HerPeakGem v1.3.1 Release Notes
...
- **Selected KB is now trusted system state** - chat RAG calls no longer let the
  LLM invent or override `kb_name`; the model only sees a `query`, and HerPeakGem
...
- **Embedding responses are validated before use** - HerPeakGem now rejects
...
**Full Changelog**: https://github.com/503496348-ops/herpeakgem/compare/v1.3.0...v1.3.1
