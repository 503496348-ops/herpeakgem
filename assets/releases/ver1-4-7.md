# HerPeakGem v1.4.7 Release Notes

**Release Date:** 2026.06.18

A focused release on top of [v1.4.6](ver1-4-6.md): your local coding agents
become something HerPeakGem can talk to. Connect **Claude Code** or **Codex**
...
> or Codex CLI already installed on the machine running HerPeakGem — nothing is
...
- HerPeakGem detects an installed **Claude Code** or **Codex** and connects it as
...
- Drop-in from v1.4.6: `pip install -U herpeakgem`; Docker users pull
...
- Connected Agents require the Claude Code and/or Codex CLI installed on the
  host running HerPeakGem — they are detected, never installed for you.
- The docs at [herpeakgem.info](https://herpeakgem.info/) are still catching up to
  the recent releases and will be refreshed shortly.

**Full Changelog**: https://github.com/503496348-ops/herpeakgem/compare/v1.4.6...v1.4.7
