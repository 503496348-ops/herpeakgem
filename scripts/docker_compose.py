...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "Docker settings: "
        f"backend={values['HERPEAKGEM_DOCKER_BACKEND_PORT']} "
        f"frontend={values['HERPEAKGEM_DOCKER_FRONTEND_PORT']} "
        f"pocketbase={values['HERPEAKGEM_DOCKER_POCKETBASE_PORT']}",
        file=sys.stderr,
    )
